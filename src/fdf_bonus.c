...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/11/10 21:50:46 by rilliano          #+#    #+#             */
/*   Updated: 2023/11/18 11:20:08 by rilliano         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int argc, char **argv)
{
	...
	if (argc != 2)
		handle_error("Error!\nTry:\t./fdf_bonus filepathname.fdf", NULL);
	...
	load_map(argv[1], map);
	set_default(map);
	mlx_key_hook(map->win_ptr, deal_key_bonus, map);
